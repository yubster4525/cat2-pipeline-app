...
\usepackage{listings}
\usepackage{fancyhdr}
\lstset{basicstyle=\ttfamily\small,breaklines=true,showstringspaces=false,columns=fullflexible,keepspaces=true}
...
\lstinputlisting[language=Java,caption={Complete Jenkinsfile used for the CAT2 pipeline},label={lst:jenkinsfile},basicstyle=\ttfamily\footnotesize,columns=fullflexible,numbers=left,numberstyle=\tiny,numbersep=6pt]{Jenkinsfile}
