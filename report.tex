...
\lstinputlisting[language=Java,caption={Complete Jenkinsfile used for the CAT2 pipeline},label={lst:jenkinsfile},basicstyle=\ttfamily\footnotesize,columns=fullflexible]{Jenkinsfile}
